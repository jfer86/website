...
if ($_POST) {
    ...
    `nombrecompleto` = :nombrecompleto,`puesto` = :puesto,`twitter` = :twitter,`facebook` = :facebook,`linkedin` = :linkedin
    WHERE `ID` = :ID;");
        ...
        <div class="mb-3">
          ...
          <input type="text"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $facebook; ?>" name="facebook" id="facebook" aria-describedby="helpId" placeholder="Faceboook">
            </div>
